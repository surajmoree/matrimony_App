                  ...
                  Container(
                      ...
                      child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                              backgroundColor: selectedButton == "Force Motors"
                                  ? Colors.blue
                                  : Colors.white),
                          child: Text(
                            'Force Motors',
                  ...
                  child: Row(
                    children: [
                     SizedBox(width: 65), 
                      Icon(Icons.directions_car_outlined),
                      SizedBox(width: 10),
                      Text('Car Details',style: TextStyle(color: Colors.black,fontSize: 20,fontWeight: FontWeight.w500))
                    ],
                  ),
                ),
                SizedBox(
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Icon(Icons.image),
                      SizedBox(width: 10),
                      Text('Car Images',style: TextStyle(color: Colors.black,fontSize: 20,fontWeight: FontWeight.w500))
                    ],
                  ),
                ),
                SizedBox(
