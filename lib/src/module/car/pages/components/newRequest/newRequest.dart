  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      child: ElevatedButton.icon(
        ...
        icon: Icon(Icons.call_outlined,color: selectedButton1 == "Call"
                                      ? Colors.white
                                      : Colors.black ,),
        label: Text('Call',style: TextStyle(color: selectedButton1 == "Call"
                                        ? Colors.white
                                        : Colors.black,),),
      ...
      child: ElevatedButton.icon(
        ...
        icon: Icon(FontAwesomeIcons.whatsapp,color: selectedButton2 == "WhatsApp"
                                      ? Colors.white
                                      : Colors.black ,),
        label: Text('WhatsApp',style: TextStyle(color: selectedButton2 == "WhatsApp"
                                        ? Colors.white
                                        : Colors.black,),),
        style: ElevatedButton.styleFrom(
...
/*
      SingleChildScrollView(    //singlechildscrollcontroller
        child: Form(
          key: _formKey,
          child: Container(
            child: Column(
