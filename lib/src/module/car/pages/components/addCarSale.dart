...
import 'package:strava_clone/src/module/car/pages/components/carTypeForSale/personalCar1.dart';
import 'package:strava_clone/src/module/car/pages/components/carTypeForSale/transportCar1.dart';
...
class _PropertySaleState extends State<PropertySale> {
  ...
  final TextEditingController residentialverifyCarController =
  ...
  final TextEditingController commercialverifyCarController =
      TextEditingController();
                          ...
                          children: [
                            ...
                            if (selectedPropertyType == 'Personal')
                              ResidentialForm(
                                ...
                                tyreController: residentialtyreController,
                            
                                verifyCarController:
                                    residentialverifyCarController,
          ...
          onPressed: () async {
            ...
            if (isValid) {
              ...
              if (selectedPropertyType == 'Personal') {
                ...
                await _storage.write(
                    key: 'varicar', value: residentialverifyCarController.text);
                await _storage.write(
                ...
                print('${residentialverifyCarController.text}');
                ...
                await _storage.write(
                    key: 'varicar', value: commercialverifyCarController.text);
                await _storage.write(
                ...
                print('${commercialverifyCarController.text}');
